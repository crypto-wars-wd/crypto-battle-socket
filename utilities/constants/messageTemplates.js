...
const battleMessages = {
  common: {
    starter: [
      ...
      'Понеслась жесткая заруба',
      'Начнем наконец этот бой!',
    ],
    singleAttack: [
    ...
    getHit: [
      'Открылся под удар противника',
      'Не ожидал такого быстрого удара',
      'Отхватил леща, теперь воняет рыбой',
      'В этот раз был слишком медленным и получил ногой в живот',
      'На мгновение задумался и получил под дых',
      'Поскользнулся на кожуре банана',
      'Был слишком самоуверен и пропустил унизительную пощечину',
      'Подставился под удар',
      'Испугался крика противника и не успел заблокировать удар',
      'Забыл чему учил наставник и получил пинка, как школьник',
      'Пытался отскочить, но оступился',
      'Был неожиданно укушен пробегающей мимо гиеной',
      'Наступил на гвоздь',
      'Вспомнил наставления учителя, пока вспоминал получил палкой по лбу',
    ],
    finisher: [
